...
public class MathCalculator {
    ...
    public static double sumMultiplyDifferenceAndDivide(double first, double second) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Результат расчета равен: " + sumMultiplyDifferenceAndDivide(10, 20));
